...
echo $c "   /                                 \  ${endc}";
echo $c "  /   https://github.com/xnSW4llOW    \ ${endc}";
...
echo  "+===========================================+" |lolcat
echo  "+ Team     : 606 Hack Team $cyan           " |lolcat
echo  "+ Author   : xnSW4llOW $w                         " |lolcat
echo  "+ Youtube  : SW4LL OW $white                   " |lolcat
echo  "+===========================================+" |lolcat
...
Trying To Exit ... "
echo  $cyan"[#]> Subscribe chanel SW4LL OW"
sleep 1
echo ""
...
echo $c "Akan ada pengumumannya di Chanel SW4LL OW !"
echo "Terima Kasih :)" |lolcat

;;

00) echo "created by : <==xnSW4llOW==>" |lolcat
exit
